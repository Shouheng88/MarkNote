...
public class FragmentHelper {
    ...
    public static void replace(AppCompatActivity activity, Fragment fragment, @IdRes int id, boolean addToBackStack) {
    ...
    public static void replace(AppCompatActivity activity, android.app.Fragment fragment, @IdRes int containerId, boolean addToBackStack) {
