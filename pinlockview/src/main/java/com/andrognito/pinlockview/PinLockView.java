...
public class PinLockView extends RecyclerView {
    ...
    private Drawable mFingerButtonDrawable;
    ...
    public void setFingerButtonDrawable(Drawable fingerBackgroundDrawable) {
        this.mFingerButtonDrawable = fingerBackgroundDrawable;
        mCustomizationOptionsBundle.setFingerButtonDrawable(fingerBackgroundDrawable);
        mAdapter.notifyDataSetChanged();
    }
    ...
    public void setFingereButtonSize(int fingerButtonSize) {
        mCustomizationOptionsBundle.setFingerButtonSize(fingerButtonSize);
        mAdapter.notifyDataSetChanged();
    }
    ...
    public void setShowFingerButton(boolean showFingerButton) {
        this.mShowDeleteButton = showFingerButton;
        mCustomizationOptionsBundle.setShowFingerButton(showFingerButton);
        mAdapter.notifyDataSetChanged();
    }
