...
public class TableInputDialog extends DialogFragment{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        View rootView = LayoutInflater.from(getContext()).inflate(R.layout.view_common_input_table_view, null, false);
        ...
        final EditText etRows = (EditText) rootView.findViewById(R.id.et_md_rows_number);
        final EditText etCols = (EditText) rootView.findViewById(R.id.et_md_cols_number);
    ...
    public TableInputDialog setButtonColor(int buttonColor){
